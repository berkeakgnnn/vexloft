...
// Brand palette — mirrors scripts/demo-data/generate.py so web + Excel match exactly.
...
export function ChartTooltip({
  ...
  return (
    <div className="rounded-xl border border-white/10 bg-[#0a0f1e]/95 px-3.5 py-2.5 shadow-2xl backdrop-blur-sm">
      {label !== undefined && (
